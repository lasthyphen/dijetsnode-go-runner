...
# e.g., ${HOME}/go/src/github.com/lasthyphen/dijetsnodego/build/avalanchego
...
`--node-config` allows to specify specific avalanchego config parameters to the new node. See [here](https://docs.djtx.network/build/references/avalanchego-config-flags) for the reference of supported flags.
...
(See [here](https://github.com/lasthyphen/dijetsnodego/blob/master/network/peer/test_peer.go) for more information.)
...
# download from https://github.com/lasthyphen/dijetsnodego/releases
# or build
rm -rf ${HOME}/go/src/github.com/lasthyphen/dijetsnodego/build
cd ${HOME}/go/src/github.com/lasthyphen/dijetsnodego
./scripts/build.sh

# ref. https://github.com/ava-labs/subnet-evm/blob/b69e47e0398b5237cda0422f6a32969e64bde346/scripts/run.sh
cd ${HOME}/go/src/github.com/ava-labs/subnet-evm
go build -v \
-o ${HOME}/go/src/github.com/lasthyphen/dijetsnodego/build/plugins/srEXiWaHuhNyGwPUi444Tu47ZEDwxTWrbQiuD7FmgSAQ6X7Dy \
./plugin

# make sure binaries are built
find ${HOME}/go/src/github.com/lasthyphen/dijetsnodego/build
# for example
# .../build
# .../build/plugins
...
```bash
# replace execPath with the path to AvalancheGo on your machine
AVALANCHEGO_EXEC_PATH="${HOME}/go/src/github.com/lasthyphen/dijetsnodego/build/avalanchego"
AVALANCHEGO_PLUGIN_PATH="${HOME}/go/src/github.com/lasthyphen/dijetsnodego/build/plugins"
...
go build -v \
-o ${HOME}/go/src/github.com/lasthyphen/dijetsnodego/build/plugins/kM6h4LYe3AcEU1MB2UNg6ubzAiDAALZzpVrbX8zn3hXF6Avd8 \
./cmd/blobvm
...
cd ${HOME}/go/src/github.com/ava-labs/timestampvm
go build -v \
-o ${HOME}/go/src/github.com/lasthyphen/dijetsnodego/build/plugins/tGas3T58KzdjcJ2iKSyiYsWiqYctRXaPTqBCA11BqEkNg8kPc \
./main
